...
async function showPreviewOfImage(imgUrl){
    let previewBox = document.getElementById("previewBox");
    previewBox.innerHTML = `<img src="${imgUrl}" style="height: 100%; width: auto; border : 2px solid grey; border-radius: 5px;" alt="tweet-img" />`;
}

// handling what to happen if save tweet button is clicked
saveTweet.addEventListener("click", async (e) => {
...
async function getTweet() {
    ...
    if(tweet.length == 0)
        tweetBox.innerHTML = `<h5>There are no tweets currently for your feed! Please follow other users of your interests to see their tweets.</h5>`
